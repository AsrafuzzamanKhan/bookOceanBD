    ...
    return (
        <section className="mb-[30px] pt-36 md:pt-36 lg:pt-0 xl:pt-28 ">
            <div className="container mx-auto">
                <div className="flex flex-col gap-y-[20px] lg:flex-row lg:gap-x-[20px] px-1 lg:px-0">
                    {/* sidebar  */}
                    ...
                    <div className=" flex flex-wrap gap-4 w-full ">
                        {/* main slider  */}
                        <div className="shadow-xl border w-full max-w-lg lg:max-w-3xl mx-auto rounded-[8px]">
