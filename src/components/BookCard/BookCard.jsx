...
const BookCard = ({ book }) => {
    ...
    return (
        ...
        <div>
            ...
            <Link to={`/book/${name.replace(/\s/g, "-")}/${_id}`}>
                <div className=" dark:border-0 dark:bg-gray-800  dark:text-white  border shadow-md w-full h-[400px]  rounded-[8px] relative group overflow-hidden">
                    {/* badge  */}
                    ...
                    <div className="flex flex-col px-2 lg:px-6 text-[14px] ">
                        ...
                        <h3 className="capitalize">({cover})</h3>
