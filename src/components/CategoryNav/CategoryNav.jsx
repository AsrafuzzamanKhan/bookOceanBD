...
const CategoryNav = () => {
    ...
    return (
        <aside className="hidden lg:block ">
            <nav className="flex flex-col w-[200px] h-[500px] rounded-[4px] overflow-hidden bg-slate-300 dark:bg-gray-800 dark:text-white ">
                <h1 className="py-4 font-semibold flex items-center justify-center capitalize bg-black text-white">All Categories</h1>
